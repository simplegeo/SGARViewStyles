...
// SGLocatorServices
//
// Created by Derek Smith on 8/21/09.
...
/*!
* @property
* @abstract The //simplegeo/ooc/cl/SGARNavigationViewControllerDataSource data source @/link that populates the @link arView arView @/link.
*/
